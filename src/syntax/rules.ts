...
import {
  LOCATIVE_PREDICATE_PRODUCTION_FIXTURES,
  LOCATIVE_PREDICATE_PRODUCTION_RULES,
} from "./locative-predicate-rules.js";
...
export { LOCATIVE_PREDICATE_PRODUCTION_FIXTURES, LOCATIVE_PREDICATE_PRODUCTION_RULES };
