export interface RuntimeSourceIdentityCandidate {
  readonly sourceKey: string;
  readonly entryId: string;
}

export interface RuntimeSourceIdentityClassification {
...
/**
 * Corpus evidence is keyed by written form + UPOS, while catalog entries are
 ...
 */
export function classifyRuntimeSourceIdentityMatches(
  candidates: readonly RuntimeSourceIdentityCandidate[],
  sourceEvidenceKeys: ReadonlySet<string>,
): RuntimeSourceIdentityClassification {
