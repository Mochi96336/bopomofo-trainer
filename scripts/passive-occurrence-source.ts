...
export interface PassiveOccurrenceEvidence {
  /** Predicate occurrences with direct AUX 被 / aux:pass. */
  ...
  /** Predicate occurrences with direct obl:agent whose case child is ADP 被. */
  ...
  /** Union of reviewed short/long passive occurrences, counted once per predicate token. */
