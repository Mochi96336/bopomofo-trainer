...
Still open from the second rule: the state records are closure-scoped `let`s rather than an explicit record, and keyboard geometry has more than one source.
