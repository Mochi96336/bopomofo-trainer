...
練習的是實體鍵盤上的注音鍵位，因此目前只針對桌面瀏覽器與實體鍵盤設計。手機與平板能開啟頁面，但軟體鍵盤與行動裝置的互動設計不在現階段範圍內。

**[開啟注音輸入訓練器](https://type.moc96336.com/)**
...
需要 Node.js 22.13 以上（CI 以 22 LTS 驗證）與 Python 3.12。
...
- [Catalog 抽樣 QA](docs/catalog-sampling-qa.md)
