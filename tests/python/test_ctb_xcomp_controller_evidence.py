...
class CtbXcompControllerEvidenceTest(unittest.TestCase):
    ...
    def test_unindexed_pro_does_not_infer_subject_control_from_shape(self) -> None:
        audit = summarize(audit_tree(self.parse_one(UNINDEXED_SUBJECT_CONTROL)))
